          ...
          <div className="col-md-6 mb-3" key={item.id}>
            <div className="card h-100">
              <div className="row g-0 h-100">
                <div className="col-4">
                  <img src={item.thumbnail} className="img-fluid rounded-start h-100" alt={item.title} style={{ objectFit: 'cover' }} />
                </div>
                <div className="col-8">
                  <div className="card-body d-flex flex-column">
                    ...
                    <button className="btn btn-danger mt-auto" onClick={() => removeFromCart(item.id)}>Remove</button>
                  </div>
                </div>
              </div>
            </div>
